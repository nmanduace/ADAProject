...
IndUse<- select(Individual,v001,v002,caseid,starts_with("d101"),d104,d106,d107,d108,d109,
                starts_with("d119"),d120,starts_with("d115"),v012,v013,v190,v191,v502)
```

## Selecting the variables from household
```{r}
HouseUse<- select(Member,hv001,hv002,hv270,hv271,ha1,ha66,ha67)
...
```{r}
write.table(ADAProject, "~/Documents/GitHub/ADAProject/ADAProject.txt")
```